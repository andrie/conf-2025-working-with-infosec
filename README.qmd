...
This is a `reveal.js` presentation, rendered using `quarto` and `motion-canvas`, used for my lightning talk at Posit Workweek, 2024.


## Live preview

This project contains a quarto website, defined in `paddling.qmd`.

You can preview the rendered version of this site at <https://andrie.quarto.pub/goes-paddling/>
...
├── paddling.qmd
├── src
│   ├── motion-canvas-ts.html # includes the MC dependencies
|
